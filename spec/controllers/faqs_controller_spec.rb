  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved faq as @faq" do
        ...
        post :create, {:faq => { "qlabel" => "invalid value" }}, valid_session
        assigns(:faq).should be_a_new(Faq)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested faq" do
        ...
        Faq.any_instance.should_receive(:update_attributes).with({ "qlabel" => "MyString" })
        put :update, {:id => faq.to_param, :faq => { "qlabel" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the faq as @faq" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Faq.any_instance.stub(:save).and_return(false)
        put :update, {:id => faq.to_param, :faq => { "qlabel" => "invalid value" }}, valid_session
        assigns(:faq).should eq(faq)
      end
